...
namespace modules {
    export namespace member {
        export namespace admin {
            export class Member extends modules.admin.admin.Component {
                groups = {
                    /**
                     * 그룹을 추가한다.
                     *
                        ...
                        new Aui.Window({
                            ...
                            buttons: [
                                ...
                                new Aui.Button({
                                    ...
                                    handler: async (button) => {
                                        const window = button.getParent() as Aui.Window;
                                        const grid = window.getItemAt(0) as Aui.Grid.Panel;
                                                    ...
                                                    new Aui.Form.Field.Select({
                                                        ...
                                                        listeners: {
                                                            change: async (
                                                                ...
                                                                form.getField('auth_url').setValue(
                                                                    record.get('auth_url')
                                                                );
                                                                ...
                                                                form.getField('user_url').setValue(
                                                                    record.get('user_url')
                                                                );
                                                                form.getField('user_id_path').setValue(
                                                                    record.get('user_id_path')
                                                                );
                                                                form.getField('user_email_path').setValue(
                                                                    record.get('user_email_path')
                                                                );
                                                                form.getField('user_name_path').setValue(
                                                                    record.get('user_name_path')
                                                                );
                                                                form.getField('user_nickname_path').setValue(
                                                                    record.get('user_nickname_path')
                                                                );
                                                                form.getField('user_photo_path').setValue(
                                                                    record.get('user_photo_path')
                                                                );
                                                            },
                                                        },
                                                    }),
                                                ...
                                                items: [
                                                    ...
                                                    new Aui.Form.Field.Text({
                                                        ...
                                                        helpText: this.printText(
                                                            'admin.oauth.clients.client_secret_help'
                                                        ),
                                                    }),
                                                    ...
                                                    new Aui.Form.Field.Select({
                                                        ...
                                                        store: new Aui.Store.Local({
                                                            ...
                                                            records: (() => {
                                                                ...
                                                                for (const separator of separators) {
                                                                    records.push([
                                                                        this.printText(
                                                                            'admin.oauth.clients.scope_separators.' +
                                                                                separator
                                                                        ),
                                                                        separator,
                                                                    ]);
                                                        ...
                                                        allowBlank: false,
                                                        helpText: this.printText(
                                                            'admin.oauth.clients.scope_separator_help'
                                                        ),
                                                    }),
                                                ],
                                            }),
                                            new Aui.Form.FieldSet({
                                                ...
                                                items: [
                                                    ...
                                                    new Aui.Form.Field.Text({
                                                        ...
                                                        allowBlank: false,
                                                        helpText: this.printText(
                                                            'admin.oauth.clients.user_id_path_help'
                                                        ),
                                                    }),
                                                    new Aui.Form.Field.Text({
                                                        ...
                                                        allowBlank: false,
                                                        helpText: this.printText(
                                                            'admin.oauth.clients.user_email_path_help'
                                                        ),
                                                    }),
                                                    new Aui.Form.Field.Text({
                                                        ...
                                                        name: 'user_name_path',
                                                        helpText: this.printText(
                                                            'admin.oauth.clients.user_name_path_help'
                                                        ),
                                                    }),
                                                    new Aui.Form.Field.Text({
                                                        ...
                                                        allowBlank: false,
                                                        helpText: this.printText(
                                                            'admin.oauth.clients.user_nickname_path_help'
                                                        ),
                                                    }),
                                                    new Aui.Form.Field.Text({
                                                        ...
                                                        helpText: this.printText(
                                                            'admin.oauth.clients.user_photo_path_help'
                                                        ),
                                                    }),
                                                    new Aui.Form.Field.Check({
                                                        ...
                                                        boxLabel: this.printText(
                                                            'admin.oauth.clients.allow_signup_help'
                                                        ),
                                                    }),
                                                ],
                                            }),
