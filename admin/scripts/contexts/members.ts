                ...
                items: [
                    ...
                    new Aui.Grid.Panel({
                        ...
                        columns: [
                            ...
                            {
                                text: (await me.getText('nickname')) as string,
                                dataIndex: 'nickname',
                                sortable: true,
                                width: 140,
                            },
                            {
                                text: (await me.getText('groups')) as string,
                                dataIndex: 'groups',
                                width: 160,
                                renderer: (value) => {
                                    return value.join(', ');
                            ...
                            {
                                text: (await me.getText('level')) as string,
                                dataIndex: 'level',
                                width: 80,
                            },
                            {
                                text: (await me.getText('joined_at')) as string,
                                dataIndex: 'joined_at',
                                width: 160,
                                sortable: true,
                                renderer: (value) => {
                            ...
                            {
                                text: (await me.getText('logged_at')) as string,
                                dataIndex: 'logged_at',
                                width: 160,
                                sortable: true,
                                renderer: (value) => {
        ...
        setUrl: () => {
            ...
            if (Admin.getContextSubUrl(0) == 'lists') {
                ...
                if (Admin.getContextSubUrl(1) == 'levels') {
                    const levels = Aui.getComponent('levels') as Aui.Tree.Panel;
